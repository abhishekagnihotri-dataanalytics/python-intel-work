...
__description__ = "This script loads WIINGS Transfer data from HANA to GSCDW DB"
...
if __name__ == "__main__":
    ...
    project_name = 'WIINGS Transfer Data'
    data_area = 'WIINGSTransferDetailQuery'
    stage_table = 'Stage.WIINGSTransferDetailQuery'
    base_table = 'Base.WIINGSTransferDetailQuery'
    load_by = 'HanaEtl'
    ...
    query = """SELECT 
         ...
         "IntelPartNbr",
         "FactoryMaterialTransferId",
         "StorageLocationCd",
         "FactoryMaterialReturnRequestTypeNm",
         "IntelPersonId",
         "StockroomDeliveryLocationDsc",
         "FactoryMaterialRequestLineFulfillmentId",
         "FactoryMaterialAcceptedTransferId",
         "PurchaseGroupCd",
         "GeneralLedgerAccountNbr",
         "FactoryMaterialTransferFulfillmentDtm",
         Sum("UnitCostAmt")                        AS "UnitCostAmt",
         Sum("FactoryMaterialAcceptedTransferQty") AS "FactoryMaterialAcceptedTransferQty"
FROM     "_SYS_BIC"."intel.factorymaterials.consumption.extracts/WIINGSTransferDetailQuery"
...
GROUP BY "OriginalIssueId",
         ...
         "PurchaseGroupCd",
         "GeneralLedgerAccountNbr",
         "FactoryMaterialTransferFulfillmentDtm" """.format(current_date=current_date, current_date_minus2=current_date_minus2)
