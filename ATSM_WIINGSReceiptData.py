...
__description__ = "This script loads WIINGS Receipt data from HANA to GSCDW DB"
...
if __name__ == "__main__":
    ...
    project_name = 'WIINGS Receipt Data'
    data_area = 'WIINGSReceiptDetailQuery'
    stage_table = 'Stage.WIINGSReceiptDetailQuery'
    base_table = 'Base.WIINGSReceiptDetailQuery'
    load_by = 'HanaEtl'
    ...
    query = """SELECT 
         ...
         "FactoryMaterialInventoryReceiptId",
         "ReceiptAcceptedByWorldwideId",
         "FactoryMaterialAcceptedReceiptId",
         "FactoryMaterialReceiptDtm",
         Sum("UnitCostAmt")            AS "UnitCostAmt",
         Sum("ReceiptAcceptedItemQty") AS "ReceiptAcceptedItemQty"
FROM     "_SYS_BIC"."intel.factorymaterials.consumption.extracts/WIINGSReceiptDetailQuery"
...
GROUP BY "ItemDsc",
         ...
         "ReceiptAcceptedByWorldwideId",
         "FactoryMaterialAcceptedReceiptId",
         "FactoryMaterialReceiptDtm" """.format(current_date=current_date, current_date_minus2=current_date_minus2)
